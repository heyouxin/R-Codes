...
result <- summary(fit)
plot(1:length(result$cp),result$cp,type = 'b',xlab = 'number of predictors')
which.min(result$cp)
plot(1:length(result$bic),result$bic,type = 'b',xlab = 'number of predictors')
which.min(result$bic)
plot(1:length(result$adjr2),result$adjr2,type = 'b',xlab = 'number of predictors')
...
plot(1:10,v.eror,type = 'b',xlab = 'number of predictors')
