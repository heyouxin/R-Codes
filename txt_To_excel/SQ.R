...
data_get<-grep("<参考文献>=.*",data_ch)
CKWX <- data_ch[data_get]
CKWX2 <- gsub("<.*?>=","",CKWX)
...
excel_data <- data.table("公开号"=GKH2,"公开日"=GKR2,"申请号"=SQH2,"申请日"=SQR2,"专利号"=ZLH2,"名称"=MC2,"主分类号"=ZFLH2,"分类号"=FLH2,"申请(专利权)人"=SQZLR2,"发明(设计)人"=FMR2,"摘要"=ZY2,"主权项"=ZQX2,"优先权"=YXQ2,"国省代码"=GSDM2,"地址"=DZ2,"专利代理机构"=ZLDLJG2,"代理人"=DLR2,"审查员"=SCY2,"发布路径"=FBLJ2,"页数"=YS2,"申请国代码"=SQGDM2,"专利类型"=ZLLX2,"申请来源"=SQLY2,"参考文献"=CKWX2)
#View(excel_data)
write.csv(excel_data,"SQ2011-2016_1.csv")